...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'El día 12 de julio realizamos el lanzamiento de 150 nuevos lotes que forman parte de la tercera etapa. Donde podrás encontrar lotes desde 90 m² hasta 300 m² a un precio especial y sobretodo con su respectiva partida registral en SUNARP para una inversión segura.',
